...
class HintsControllerTest < ActionController::TestCase
  ...
  test "should create hint" do
    assert_difference('Hint.count') do
      post :create, hint: { description: @hint.description, name: @hint.name, photo: @hint.photo, thumbnail: @hint.thumbnail }
    end
  ...
  test "should update hint" do
    patch :update, id: @hint, hint: { description: @hint.description, name: @hint.name, photo: @hint.photo, thumbnail: @hint.thumbnail }
    assert_redirected_to hint_path(assigns(:hint))
  end
